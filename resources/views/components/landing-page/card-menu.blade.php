@props(['title', 'description', 'icon' => 'fa-file-lines'])
            ...
            <div class="our_solution_category">
                <div class="solution_cards_box">
                    <div class="solution_card">
                        ...
                        <div class="solu_title">
                            <h3>Cari Lokasi Makam</h3>
                        </div>
                        <div class="solution_description">
                            <p>
                                Mencari lokasi makam yang ada di Makam Purwosari
                            </p>
                            <a href="/request-list" class="read_more_btn">Cari lokasi makam</a>
                        </div>
                    </div>
                    ...
                    <div class="solution_card">
                        ...
                        <div class="solu_title">
                            <h3>Cari Data Jenazah</h3>
                        </div>
                        <div class="solution_description">
                            <p>
                                Mencari jenazah berdasarkan nama jenazah yang ada di Makam Purwosari
                            </p>
                            <a href="/corpse-list" class="read_more_btn">Cari data</a>
                        </div>
                    </div>
                </div>
                <!--  -->
                <div class="solution_cards_box sol_card_top_3">
                    <div class="solution_card">
                        ...
                        <div class="solu_title">
                            <h3>Form Pengajuan Makam</h3>
                        </div>
                        <div class="solution_description">
                            <p>
                                Form input pengajuan makam atau data jenazah yang belum terdaftar
                            </p>
                            <a href="/request" class="read_more_btn">Buat Pengajuan</a>
                        </div>
                    </div>
                    <div class="solution_card">
                        <div class="hover_color_bubble"></div>
                        ...
                        <div class="solution_description">
                            <p>
                                Riwayat pengajuan makam yang sudah terdaftar dan sudah mendapatkan nomor
                                urut, lihat status pengajuanmu disini
                            </p>
                            <a href="/request-list" class="read_more_btn">Lihat Pengajuan</a>
                        </div>
                    </div>
                </div>
            </div>
...
<style>
    ...
    .solution_cards_box .solution_card:hover .solution_description p {
        color: #fff;
    }
    ...
    .solution_cards_box .solution_card:hover .solution_description button {
    ...
    .solution_card .solution_description p {
        font-size: 15px;
        margin-bottom: 15px;
    }

    .solution_card .solution_description button {
        border: 0;
        border-radius: 15px;
