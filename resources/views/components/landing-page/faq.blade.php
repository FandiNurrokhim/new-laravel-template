  <section class="bsb-faq-2 bg-white py-3 py-md-5 py-xl-8" id="faq">
        <div class="container">
            <div class="row gy-5 gy-lg-0">
                <div class="col-12 col-lg-6" data-aos="fade-up-right">
                    <div class="row justify-content-xl-end">
                        <h2 class="h1 text-center mb-3">Yang sering ditanyakan
                        </h2>
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <ul>
                                                ...
                                                <li>Click on your profile picture in the top right corner of the page and
                                                    select "Account Settings."</li>
                                ...
                                <div class="accordion-item mb-4 shadow-sm">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            factors, including your location, the type of services you are receiving, and
                                            the policies of the company providing you with those services.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item mb-4 shadow-sm">
                                    ...
                                    <div id="collapseFour" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            The currency you are charged in when making a purchase will depend on a number
                                            of factors, including the merchant you are purchasing from, the country you are
                ...
                <div class="col-12 col-lg-6" data-aos="fade-up-left">
                    <img class="img-fluid rounded" loading="lazy" src="{{ asset('img/elements/faq-img.jpg') }}"
                        alt="Faq">
                </div>
            </div>
        </div>
